...
<html lang="en">
<head>
	<title>Master Customer Report</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Master Customer Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Master Customer Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
				$query = "SELECT id, name, department, acc_num, phone, email FROM customers;";
