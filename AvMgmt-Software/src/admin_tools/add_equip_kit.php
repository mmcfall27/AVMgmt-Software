...
<html lang="en">
<head>
	<title>Add equipment to kit</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Add equipment to kit</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Add equipment to kit</div>
        <div class="panel-body">
			<form name = 'form1' action="./php_actions/add_equip_kit_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Kit Stock Number:
	...
	<div class="col-sm-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<table id='customers'>
					   <?php
							$query = "SELECT stock_num, equip_name, model_num, serial_num
							FROM equip_inv;";
