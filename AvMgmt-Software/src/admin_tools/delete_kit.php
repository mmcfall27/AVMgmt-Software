...
<body onload='document.form1.kit.focus()'>
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Delete kit</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Delete kit</div>
        <div class="panel-body">
			<form name = 'form1' action="./php_actions/delete_kit_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Kit Stock Number:
	...
	<div class="col-sm-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<table id='customers'>
					   <?php
							$query = "SELECT equip_kits.kit_stock_num, equip_inv.equip_name
							FROM equip_kits
							INNER JOIN equip_inv ON equip_inv.stock_num = equip_kits.kit_stock_num;";
