...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Broken Equipment</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Broken Equipment</div>
        <div class="panel-body">
			<form name = 'maint' action="./php_actions/add_broke_equip_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Stock Number:
					...
					<tr>
						<td>
							Broken Equipment Description:
						</td>
						<td>
							<textarea cols='22' rows = '10' style='resize:vertical' name='broke_info' id='broke_info' placeholder='Please type a brief reason you marked the item as broken.'></textarea>
						</td>
					</tr>
					<tr>
						<td colspan = '2'>
