	...
	<div class="row" align='center'>
		<div class="col-sm-6 col-sm-offset-3">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">Checkout Step 3</div>
					...
					<form name='check_out' action='./actions/process_checkout.php' method='post'>
						<table>
							<tr>
								...
								<td>
									<?php
										$work_num = rand(pow(10, 4), pow(10, 5)-1);
										$id = $_POST["cust_id"];
										
										//Query to check if randomly generated work_num already exists and replace if need be
										$q1 = "select work_no from loan where work_no = $work_num";
