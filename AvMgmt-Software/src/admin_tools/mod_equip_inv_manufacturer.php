...
<html lang="en">
<head>
  <title>Modify manufacturer Column</title>
  <meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Modify manufacturer Column</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Modify manufacturer column</div>
        <div class="panel-body">
			<form name='form1' action="./php_actions/mod_equip_inv_manufacturer_action.php" method="post">
				<table name="addmtsu" align='center'>
					...
					<tr>
						...
						<td>
							<input type='text' placeholder = 'Use Reference' name = 'manufacturer' required>
						</td>
					</tr>
					<tr>
						<td colspan='2'>
				...
				<div class="panel-heading text-center">Reference</div>
					<div class="panel-body">
						<table id='dept' class='table col-sm-6'>
							<?php
							$query = "SELECT stock_num, manufacturer FROM equip_inv;";
