...
<body onload = 'document.form1.dept_id.focus()'>
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Remove Department Form</font></h3>
		</div>
	...
	<div class="row">
		<div class="col-sm-5">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">Remove Department</div>
				<div class="panel-body" align='center'>
					<form name = 'form1' action="./php_actions/remove_dept_action.php" method="post">
						<table name="addemp">
							<tr>
								<td>
									Department ID:
			...
			<div class="panel panel-primary">
				<div class="panel-heading text-center">Reference</div>
					<div class="panel-body">
						<table id='dept' class='table col-sm-7'>
							<?php
							$query = "SELECT id, acc_num, dept_name FROM departments;";
