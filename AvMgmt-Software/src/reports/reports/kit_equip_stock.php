...
<html lang="en">
<head>
  <title>Kit Equipment: Kit Stock Number</title>
  <meta charset="utf-8">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Kit Equipment: Kit Stock Number</div>
        <div class="panel-body" align='center'>
			<form name = 'form1' action = './action/kit_equip_stock_action.php' method = 'post'>
				<table>
					<tr>
						<td>
							Kit Stock Number
						...
						<td>
							<input type = 'number' name = 'kstock' required>
						</td>
					</tr>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
				$query = "SELECT equip_name, stock_num, model_num, serial_num
							FROM equip_inv
							WHERE broken = 'no'
							AND kit_master = 'yes';";
