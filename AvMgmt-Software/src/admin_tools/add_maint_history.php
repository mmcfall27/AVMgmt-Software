...
<html lang="en">
<head>
	<title>Maintenance Documentation</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Maintenance Documentation</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Maintenance Documentation</div>
        <div class="panel-body">
			<form name = 'maint' action="./php_actions/add_maint_history_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Stock Number:
					...
					<tr>
						...
						<td>
							<textarea cols='22' rows = '10' style='resize:vertical' name='maint_info' id='maint_info' placeholder='Please type a brief description of the maintenance actions performed'></textarea>
						</td>
					</tr>
					<tr>
						<td colspan = '2'>
