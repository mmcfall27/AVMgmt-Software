...
<html lang="en">
<head>
  <title>Modify equip_inv Table</title>
  <meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Modify equip_inv Table</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Modify mtsu_asset_num Column</div>
        <div class="panel-body">
			<form name='mtnum' action="./php_actions/mod_equip_inv_mtsu_asset_num_action.php" method="post">
				<table name="addmtsu" align='center'>
					...
					<tr>
						...
						<td>
							<input type='text' id='mtsu_num' name='mtsu_num' required>
						</td>
					</tr>
					<tr>
						<td colspan='2'>
