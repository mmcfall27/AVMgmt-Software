...
<html lang="en">
<head>
  <title>Modify total_activity Column</title>
  <meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Modify total_activity Column</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Modify total_activity column</div>
        <div class="panel-body">
			<form name='form1' action="./php_actions/mod_equip_inv_total_activity_action.php" method="post">
				<table name="addmtsu" align='center'>
					...
					<tr>
						...
						<td>
							<input type='number' placeholder = 'Use Reference' name = 'total_activity' required>
						</td>
					</tr>
					<tr>
						<td colspan='2'>
				...
				<div class="panel-heading text-center">Reference</div>
					<div class="panel-body">
						<table id='dept' class='table col-sm-6'>
							<?php
							$query = "SELECT stock_num, total_activity FROM equip_inv;";
							...
							while($row = mysqli_fetch_assoc($result))
							{
								echo "['".htmlspecialchars($row['stock_num'],ENT_QUOTES)."', '"
									 .htmlspecialchars($row['total_activity'],ENT_QUOTES)."'],";
							};
							echo   "];";
