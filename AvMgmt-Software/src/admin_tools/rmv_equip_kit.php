...
<html lang="en">
<head>
	<title>Remove equipment from kit</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Remove equipment from kit</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Remove equipment from kit</div>
        <div class="panel-body">
			<form name = 'form1' action="./php_actions/rmv_equip_kit_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Kit Stock Number:
						...
						<td>
							<input type='number' placeholder='Scan/Type Barcode' name='kit' required>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type='number' placeholder='Scan/Type Barcode' name='equip' required>
						</td>
					</tr>
					<tr>
						<td colspan = '2'>
