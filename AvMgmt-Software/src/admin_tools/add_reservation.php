...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Reserve Equipment</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Reserve Equipment</div>
        <div class="panel-body">
			<form name = 'form1' action="./php_actions/add_reservation_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Stock Number:
					...
					<tr>
						...
						<td>
							<input type='number' placeholder = 'Use Reference' name = 'cust_id' required>
						</td>
					</tr>
					<tr>
						<td>
	...
	<div class="col-sm-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<table id='customers'>
					   <?php
							$query = "SELECT id, name, department, acc_num FROM customers;";
