...
<html lang="en">
<head>
  <title>Modify serial_num Column</title>
  <meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Modify serial_num Column</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Modify serial_num column</div>
        <div class="panel-body">
			<form name='form1' action="./php_actions/mod_equip_inv_serial_num_action.php" method="post">
				<table name="addmtsu" align='center'>
					...
					<tr>
						...
						<td>
							<input type='text' placeholder = 'Use Reference' name = 'serial_num' required>
						</td>
					</tr>
					<tr>
						<td colspan='2'>
				...
				<div class="panel-heading text-center">Reference</div>
					<div class="panel-body">
						<table id='dept' class='table col-sm-6'>
							<?php
							$query = "SELECT stock_num, serial_num FROM equip_inv;";
