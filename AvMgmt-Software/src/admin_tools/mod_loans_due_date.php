...
<html lang="en">
<head>
  <title>Change loan due date</title>
  <meta charset="utf-8">
...
<body onload='document.duedate.loan_id.focus()'>
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Change loan due date Form</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Modify due_date column</div>
        <div class="panel-body">
			<form name='duedate' action="./php_actions/mod_loans_due_date_action.php" method="post">
				<table name="addmtsu" align='center'>
					<tr>
						...
						<td>
							<input type="number" id='loan_id' placeholder='Use Reference' name="loan_id" required>
						</td>
					</tr>
					<tr>
						<td>
				...
				<div class="panel-heading text-center">Reference</div>
					<div class="panel-body">
						<table id='dept' class='table col-sm-6'>
							<?php
							$query = "select loans.loan_id, loans.stock_num, equip_inv.equip_name, customers.name, loans.due_date
										from loans
