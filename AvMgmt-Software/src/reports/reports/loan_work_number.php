...
<html lang="en">
<head>
  <title>Loan Report: Work Number</title>
  <meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Loan Report: Work Number</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Loan Report: Work Number</div>
        <div class="panel-body">
			<form name = 'form1' action="./action/loan_work_number_action.php" method="post">
