...
<html lang="en">
<head>
	<title>Available Equipment Report</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Available Equipment Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Available Equipment Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
				$query = "SELECT equip_name, stock_num, model_num, manufacturer 
							FROM equip_inv
							WHERE broken = 'no'
							AND in_maintenance = 0
							AND checked_out = 'no'
							AND reserved = 'no';";
