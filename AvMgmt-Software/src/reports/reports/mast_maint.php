...
<html lang="en">
<head>
	<title>Master Maintenance Report</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Master Maintenance Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Master Equipment Maintenance Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
					$query = "SELECT equip_inv.stock_num, equip_inv.equip_name, maintenance.reason 
								FROM equip_inv 
								INNER JOIN maintenance on maintenance.stock_num = equip_inv.stock_num
					...
					while($row = mysqli_fetch_assoc($result))
					{
						echo "['".htmlspecialchars($row['stock_num'],ENT_QUOTES)."', '"
							 ...
							 .htmlspecialchars($row['reason'],ENT_QUOTES)."'],";
					};
					echo   "];";
