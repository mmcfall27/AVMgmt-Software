...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Employee Birthday Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Employee Birthday Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
				$query = "SELECT first_name, last_name, emp_bday FROM emp_info;";
				...
				while($row = mysqli_fetch_assoc($result))
				{
					echo "['".htmlspecialchars($row['first_name'],ENT_QUOTES)."', '"
						 ...
						 .htmlspecialchars($row['emp_bday'],ENT_QUOTES)."'],";
				};
				echo   "];";
