...
<html lang="en">
<head>
	<title>Equipment Checkin Form</title>
	<meta charset="utf-8">
...
<?php
	...
	$work = $_POST["work_num"];
	$query = "SELECT loans.work_num, loans.stock_num, loans.acc_num, loans.checkout_clerk, loans.checkout_date, loans.due_date, customers.name, departments.dept_name, equip_inv.equip_name, equip_inv.in_maintenance FROM loans 
			...
			where returned = 'yes' and work_num = $work;";
...
<div class="container">    
	...
	<div class="row">
		...
		<div class = 'row'>
			<div class = 'col-sm-12' align = 'center'>
				<br><b>Comments Section</b>
			</div>
		</div>
		<div class = 'row'>
			<div class = 'col-sm-12' align = 'center'>
				<textarea class = 'textarea1' name = 'comments' placeholder = 'Maintenance, Lost Equipment, and Broken Equipment Comments Here'></textarea>
			</div>
		</div>
		<div class = 'row'>
		...
		<div class = 'row'>
			<div class = 'col-sm-12' align = 'left'>
				<label class = 'sig'>Employee Signature:__________________________________________________________</label>
			</div>
		</div>
		<div class = 'row'>
			<div class = 'col-sm-12' align = 'center'>
				<br><b>***In the event of equipment damage/loss, the repair/replacement cost of the item will be charged to the account number used during the checkout process.***</b>
			</div>
		</div><br><br>
		<div class = 'row'>
			<div class = 'col-sm-6' align = 'center'>
				<form action = "../../reports_admin.php" class = 'hidden-print'>
					<input type = 'submit' value = 'Return to Report Selection Page'>
				</form>
			</div>
			<div class = 'col-sm-6' align = 'center'>
