...
<html lang="en">
<head>
	<title>Total Checkouts by Cust. Report</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Total Checkouts by Cust. Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Total Checkouts by Cust. Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				...
				$query = "SELECT loans.loan_id, loans.work_num, loans.stock_num, loans.acc_num, customers.name, loans.checkout_clerk, loans.checkout_date, equip_inv.equip_name
							FROM loans 
							INNER JOIN customers on customers.id = loans.cust_id
							INNER JOIN equip_inv on equip_inv.stock_num = loans.stock_num
							where loans.checkout_date BETWEEN '$start_date' AND '$end_date'
							AND loans.cust_id = $cust_id;";
				...
				while($row = mysqli_fetch_assoc($result))
				{
					echo "['".htmlspecialchars($row['loan_id'],ENT_QUOTES)."', '"
						 ...
						 .htmlspecialchars($row['checkout_date'],ENT_QUOTES)."', '"
