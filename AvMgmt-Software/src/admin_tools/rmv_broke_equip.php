...
<html lang="en">
<head>
	<title>Remove Broken Equipment</title>
	<meta charset="utf-8">
...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Remove Broken Equipment</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Remove from Broken Equipment Table</div>
        <div class="panel-body">
			<form name = 'maint' action="./php_actions/rmv_broke_equip_action.php" method='post'>
				<table align='center'>
					<tr>
						<td>
							Stock Number:
			...
			<div class="panel-heading text-center">Reference</div>
				<div class="panel-body">
					<table id='dept' class='table col-sm-6'>
						<?php
							$query = "SELECT broken_equipment.broken_equip_stock_num, broken_equipment.broken_how, equip_inv.equip_name
										FROM broken_equipment
										INNER JOIN equip_inv ON equip_inv.stock_num = broken_equipment.broken_equip_stock_num;";
							...
							{
								echo "['".htmlspecialchars($row['broken_equip_stock_num'],ENT_QUOTES)."', '"
