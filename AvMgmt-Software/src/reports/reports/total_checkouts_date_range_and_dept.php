...
<html lang="en">
<head>
  <title>Total Checkouts by Account Number</title>
  <meta charset="utf-8">
...
<body onload = 'myform.account_num.focus()'>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Total Checkouts by Account Number</div>
        <div class="panel-body" align='center'>
			<form class = 'myform' action = './action/total_checkouts_date_range_and_dept_action.php' method = 'post'>
				<table>
					<tr>
						<td class = 'myrow'>
							Account Number:
						...
						<td class = 'myrow'>
							<input type = 'text' name = 'account_num' placeholder = 'Use Reference' required>
						</td>
					</tr>
					<tr>
						<td class = 'myrow'>
