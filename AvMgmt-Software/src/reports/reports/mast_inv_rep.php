...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Master Inventory Report</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-12 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Master Equipment Inventory Report</div>
        <div class="panel-body">
			<table id='dept' class='table col-sm-12'>
				<?php
				$query = "SELECT equip_name, stock_num, model_num, serial_num, mtsu_asset_num, date_received, equip_cost, manufacturer, total_activity 
							FROM equip_inv
							WHERE broken = 'no';";
