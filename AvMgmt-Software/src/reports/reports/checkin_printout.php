...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Checkin Printout</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Checkin Printout</div>
        <div class="panel-body">
			<form name = 'form1' action="./action/checkin_printout_action.php" method="post">
