...
<body onload='document.addcust.first_name.focus()'>
		...
		<div class="col-sm-6">
			<div class="panel panel-primary">
				...
				<div class="panel-body" align='center'>
					<?php
						if($_SESSION["addcust_code"] == 2){
							echo "Failure: Customer already exists.<hr>";
						}
					?>
					<form name = 'addcust' action="./actions/addcust.php" method="post">
						<table name="addemp">
							<tr>
								<td>
									First Name:
							...
							<tr>
								...
								<td align='right'>
									<input type="reset" value="Reset Form" onclick = 'document.addcust.first_name.focuse()'>
								</td>
							</tr>
						</table>
					</form>
