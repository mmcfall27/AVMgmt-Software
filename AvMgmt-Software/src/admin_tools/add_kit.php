...
<div class="jumbotron">
	<div class='row'>
		...
		<div class="container text-center col-sm-4">
			<h3><font color = "white">A/V Services<br><br>Add Equipment Kit</font></h3>
		</div>
  ...
  <div class="row">
    <div class="col-sm-6 col-centered">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Add Equipment Kit</div>
        <div class="panel-body">
			<form name = 'addinv' action="./php_actions/add_kit_action.php" method="post">
				<table name="addinv" align='center'>
					...
					<tr>
						<td>
							<input type="submit" value="Add Kit to Inventory">
						</td>
						<td align = 'right'>
