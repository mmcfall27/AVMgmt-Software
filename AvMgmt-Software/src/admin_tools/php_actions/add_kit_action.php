<?php
	...
	//Database Queries
	$q1 = "insert into equip_inv(stock_num, mtsu_asset_num, equip_name, equip_location, date_received, manufacturer, equip_cost, model_num, serial_num, kit_master) VALUES($stock,$mtsu,\"$name\",\"$loc\",\"$date\",\"$manufacturer\",$cost,'$model_num','$serial_num', 'yes')";
